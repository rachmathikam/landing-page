    ...
    <!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/auth-pro/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Oct 2022 04:16:46 GMT -->
    ...
    <body class=" ">
            ...
            <div class="iq-auth-page">
                ...
                <div class="container-fluid">
                    <a href="../index-2.html" class="iq-link d-flex align-items-center">
                        <img src="https://templates.iqonic.design/hope-ui/pro/html/assets/images/favicon.ico"
                ...
                <div class="iq-banner-logo d-none d-lg-block">
                    <img class="auth-image" src="{{ asset('template/images/01.png') }}" alt="logo-img" loading="lazy" />
                </div>
                    ...
                    <div class="col-10 col-xl-4 offset-xl-7 offset-1">
                        <div class="card">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <p class="text-center">Don't have account?<a href="sign-up.html" class="ms-2">
                                        Click
                                        here to sign up.</a></p>
                            </div>
                        </div>
        ...
        <div class="offcanvas offcanvas-end live-customizer" tabindex="-1" id="live-customizer"
            data-bs-scroll="true" data-bs-backdrop="false" aria-labelledby="live-customizer-label">
                                ...
                                <div>
                                    ...
                                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                                        <div data-setting="attribute" class="text-center">
                                            ...
                                            <label class="btn btn-border d-block p-0"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div data-setting="radio">
                                                ...
                                                <label class="btn bg-transparent px-2 border-0"
                                                    ...
                                                    data-bs-placement="top" title="Reset Color"
                                    ...
                                    <div class="collapse" id="custom-color">
                                        <div class="form-group d-flex justify-content-between align-items-center">
                                            ...
                                            <input class="" name="theme_color" data-extra="primary"
                                                type="color" id="custom-primary-color" value="#3a57e8"
                                                data-setting="color">
                                        </div>
                                        <div
                                            ...
                                            <input class="" name="theme_color" data-extra="info"
                                                type="color" id="custom-info-color" value="#08B1BA"
                                                data-setting="color">
                                        </div>
                                    </div>
                            ...
                            <div class="p-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group mb-0">
                                            <select name="heading_font_family" class="form-control"
                                                data-select="font" data-setting="select">
                                ...
                                <div class="d-grid gap-3 grid-cols-3 mb-4">
                                    ...
                                    <div data-setting="radio">
                                        ...
                                        <label class="btn btn-border d-block"
                                            for="save-sessionstorage">Session</label>
                                    </div>
                                    <div data-setting="radio">
    ...
    <!-- Mirrored from templates.iqonic.design/hope-ui/pro/html/dashboard/auth-pro/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 10 Oct 2022 04:16:47 GMT -->
