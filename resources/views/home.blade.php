                        ...
                        <div class="col-md-6">
                            <div class="iq-scroller-effect">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="table/border-table.html" class="badge rounded-pill bg-soft-primary">
                                        All Contacts
                                    </a>
                                </div>
                                <div class="d-flex align-items-center iq-slider mb-4 gap-2">
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2"
                                            src="{{ asset('template/images/table/1.png') }}" alt="profile"
                                            loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2"
                                            src="{{ asset('template/images/table/2.png') }}" alt="profile"
                                            loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2"
                                            src="{{ asset('template/images/table/3.png') }}" alt="profile"
                                            loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2"
                                            src="{{ asset('template/images/table/4.png') }}" alt="profile"
                                            loading="lazy" />
                                    </div>
                                    <div>
                                        <img class="rounded-circle bg-soft-primary img-fluid avatar-40 mb-2"
                                            src="{{ asset('template/images/table/5.png') }}" alt="profile"
                                            loading="lazy" />
                                    </div>
                                </div>
                                <div>
                                    <div class="form-group">
                                        <select class="select2-basic-single js-states form-control form-group"
                ...
                <nav class="tab-bottom-bordered">
                    <div class="mb-0 nav nav-tabs justify-content-around" id="nav-tab1" role="tablist">
                        <button class="nav-link py-3 active" id="nav-home-11-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-home-11" type="button" role="tab" aria-controls="nav-home-11"
                            aria-selected="true">Payments</button>
                        <button class="nav-link py-3" id="nav-profile-11-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-profile-11" type="button" role="tab"
                            aria-controls="nav-profile-11" aria-selected="false">Settlements</button>
                        <button class="nav-link py-3" id="nav-contact-11-tab" data-bs-toggle="tab"
                            data-bs-target="#nav-contact-11" type="button" role="tab"
                            aria-controls="nav-contact-11" aria-selected="false">Refunds</button>
                    </div>
                </nav>
