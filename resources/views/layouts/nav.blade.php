                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link "
                                                href="index-dual-horizontal.html">Dual Horizontal
                                                Dashboard</a></li>
                                        <li class="nav-item"><a class="nav-link " href="index-dual-compact.html">Dual
                                                Compact</a></li>
                                        <li class="nav-item"><a class="nav-link " href="index-boxed.html">Boxed
                                                Horizontal</a></li>
                                        <li class="nav-item"><a class="nav-link " href="index-boxed-fancy.html">Boxed
                                                Fancy</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/e-commerce/index.html">E-Commerce</a>
                                </li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/social-app/index.html">Social
                                        App</a></li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/blog/index.html">Blog</a>
                                </li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/appointment/index.html">Appointment</a>
                                </li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/file-manager/index.html">File
                                        Manager</a></li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/chat/index.html"
                                        target="_blank">Chat</a></li>
                                <li class="nav-item"><a class="nav-link "
                                        href="https://templates.iqonic.design/hope-ui/pro/html/mail/index.html">Mail</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                <li class="nav-item"><a class="nav-link "
                                                        href="auth/confirm-mail.html">Email Verified</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link menu-arrow" data-bs-toggle="collapse"
                                                href="#animatedAuth" role="button" aria-expanded="false"
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                <li class="nav-item"><a class="nav-link "
                                                        href="auth-pro/lock-screen.html">Lock screen</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link "
                                                        href="auth-pro/reset-password.html">Reset
                                                        password</a></li>
                                                <li class="nav-item"><a class="nav-link "
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link menu-arrow" data-bs-toggle="collapse"
                                                href="#simpleAuth" role="button" aria-expanded="false"
                                            ...
                                            <ul aria-expanded="false"
                                                ...
                                                id="simpleAuth">
                                                <li class="nav-item"><a class="nav-link "
                                                        href="simple-auth-pro/sign-in.html">Sign In</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link "
                                                        href="simple-auth-pro/sign-up.html">Sign Up</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="errors/error404.html">404</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link " href="errors/error500.html">505</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="plugins/uppy.html">Uppy</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        id="mapPages">
                                        <li class="nav-item"><a class="nav-link " href="maps/google.html">Google</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link " href="maps/vector.html">Vector</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse"
                                        ...
                                        <li class="nav-item"><a class="nav-link " href="table/fancy-table.html">Fancy
                                                Table</a></li>
                                        <li class="nav-item"><a class="nav-link " href="table/fixed-table.html">Fixed
                                                Table</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="m-0 shadow-none card">
                            ...
                            <div class="p-0 card-body max-17 scroll-thin">
                                <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('template/images/shapes/01.png') }}" alt=""
                                            loading="lazy" />
                                ...
                                <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('template/images/shapes/02.png') }}" alt=""
                                            loading="lazy" />
                                        <div class="ms-3 flex-grow-1">
                                ...
                                <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('template/images/shapes/03.png') }}" alt=""
                                            loading="lazy" />
                                        <div class="ms-3 flex-grow-1">
                                ...
                                <div class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('template/images/shapes/04.png') }}" alt=""
                                            loading="lazy" />
                                        <div class="ms-3 flex-grow-1">
