...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('template/vendor/flatpickr/dist/flatpickr.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('template/vendor/sheperd/dist/css/sheperd.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('template/css/hope-ui.min28b5.css?v=2.0.0') }}" />
    <link rel="stylesheet" href="{{ asset('template/css/pro.min28b5.css?v=2.0.0') }}" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ asset('template/css/custom.min28b5.css?v=2.0.0') }}" />

    <!-- Dark Css -->
    <link rel="stylesheet" href="{{ asset('template/css/dark.min28b5.css?v=2.0.0') }}" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="{{ asset('template/css/customizer.min28b5.css?v=2.0.0') }}" />

    <!-- RTL Css -->
    <link rel="stylesheet" href="{{ asset('template/css/rtl.min28b5.css?v=2.0.0') }}" />
...
<body class="  ">
                                ...
                                <div class="d-grid gap-3 grid-cols-2 mb-4">
                                    <div data-setting="attribute" class="text-center">
                                        ...
                                        <label class="btn btn-border d-block p-0" for="theme-scheme-direction-ltr">
                                            <img src="{{ asset('template/images/settings/dark/01.png') }}"
                                                alt="ltr" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/01.png') }}"
                                    ...
                                    <div data-setting="attribute" class="text-center">
                                        ...
                                        <label class="btn btn-border d-block p-0" for="theme-scheme-direction-rtl">
                                            <img src="{{ asset('template/images/settings/dark/02.png') }}"
                                                alt="ltr" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/02.png') }}"
                                                alt="ltr" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                ...
                                <div class="d-grid gap-3 grid-cols-4 mb-4">
                                    <div data-setting="checkbox" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-mini">
                                            <img src="{{ asset('template/images/settings/dark/03.pn') }}g"
                                                alt="mini" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/03.pn') }}g"
                                    ...
                                    <div data-setting="checkbox" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-hover">
                                            <img src="{{ asset('template/images/settings/dark/04.png') }}"
                                                alt="hover" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/04.png') }}"
                                    ...
                                    <div data-setting="checkbox" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="sidebar-boxed">
                                            <img src="{{ asset('template/images/settings/dark/05.png') }}"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/05.png') }}"
                                ...
                                <div class="d-grid gap-3 grid-cols-3 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-rounded">
                                            <img src="{{ asset('template/images/settings/dark/06.pn') }}g"
                                                alt="mini" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/06.pn') }}g"
                                                alt="mini" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ asset('template/images/settings/dark/07.png') }}"
                                                alt="hover" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/07.png') }}"
                                                alt="hover" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill">
                                            <img src="{{ asset('template/images/settings/dark/08.png') }}"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/08.png') }}"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-pill-all">
                                            <img src="{{ asset('template/images/settings/dark/09.png') }}"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/09.png') }}"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border position-relative p-0 d-block overflow-hidden"
                                            for="left-bordered">
                                            <img src="{{ asset('template/images/settings/dark/14.png') }}"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/14.png') }}"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <small
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border position-relative p-0 d-block overflow-hidden"
                                            for="navs-full-width">
                                            <img src="{{ asset('template/images/settings/dark/15.png') }}"
                                                alt="boxed" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/15.png') }}"
                                                alt="boxed" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <small
                                                class="badge bg-danger position-absolute top-1 end-0 m-2">Pro</small>
                                ...
                                <div class="d-grid gap-3 grid-cols-4 mb-4">
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="nav-glass">
                                            <img src="{{ asset('template/images/settings/dark/10.png') }}"
                                                alt="hover" class="mode dark-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                            <img src="{{ asset('template/images/settings/light/10.png') }}"
                                                alt="hover" class="mode light-img img-fluid" width="200"
                                                height="200" loading="lazy">
                                        </label>
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden" for="navs-sticky">
                                            <img src="{{ 'template/images/settings/dark/04.png' }}" alt="hover"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ 'template/images/settings/light/04.png' }}" alt="hover"
                                    ...
                                    <div data-setting="radio" class="text-center">
                                        ...
                                        <label class="btn btn-border p-0 d-block overflow-hidden"
                                            ...
                                            <img src="{{ 'template/images/settings/dark/12.png' }}" alt="boxed"
                                                class="mode dark-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                            <img src="{{ 'template/images/settings/light/12.png' }}" alt="boxed"
                                                class="mode light-img img-fluid" width="200" height="200"
                                                loading="lazy">
                                        </label>
    ...
    <!-- Plugin Scripts -->
    <!-- Tour plugin Start -->
    <script src="{{ asset('template/vendor/sheperd/dist/js/sheperd.min.js') }}"></script>
    <script src="{{ asset('template/js/plugins/tour.js') }}" defer></script>


    <!-- Flatpickr Script -->
    <script src="{{ asset('template/vendor/flatpickr/dist/flatpickr.min.js') }}"></script>
    <script src="{{ asset('template/js/plugins/flatpickr.js') }}" defer></script>
    ...
    <!-- Widgetchart Script -->
    <script src="{{ asset('template/js/charts/widgetcharts28b5.js?v=2.0.0') }}" defer></script>
    <!-- Dashboard Script -->
    <script src="{{ asset('template/js/charts/dashboard28b5.js?v=2.0.0') }}" defer></script>
    <!-- Hopeui Script -->
    <script src="{{ asset('template/js/hope-ui28b5.js?v=2.0.0') }}" defer></script>
    <script src="{{ asset('template/js/hope-uipro28b5.js?v=2.0.0') }}" defer></script>
    <script src="{{ asset('template/js/sidebar28b5.js?v=2.0.0') }}" defer></script>
</body>
